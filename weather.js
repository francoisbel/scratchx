...
(function(ext) {
    ...
    var descriptor = {
        ...
        // 
        blocks: [
            ['R', 'current temperature in %s', 'getTemp', 'Montreal,CA'],
            ['R', 'current wind speed in %s', 'getWindSpeed', 'Montreal,CA'],
            ['R', 'current wind direction in %s', 'getWindDirection', 'Montreal,CA'],
            ['R', 'current cloud coverage in %s', 'getCloudCover', 'Montreal,CA'],
            ['R', 'current weather in %s', 'getWeather', 'Montreal,CA']
        ],
        menus: {
        },
    ...
    ScratchExtensions.register('@francoisbel - MyWeather', descriptor, ext);
})({});
